...
class SimpleBrainLoaderWithCustomCircle extends StatefulWidget {
  ...
  @override
  State<SimpleBrainLoaderWithCustomCircle> createState() =>
      _SimpleBrainLoaderWithCustomCircleState();
}

class _SimpleBrainLoaderWithCustomCircleState
    extends State<SimpleBrainLoaderWithCustomCircle>
    with TickerProviderStateMixin {
  late AnimationController _circleController;
