  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize: const Size.fromHeight(kToolbarHeight + 32), // Increased height to accommodate banner
        child: Consumer(
          builder: (context, ref, _) {
            final isPrivate = ref.watch(privateChatProvider);
            return PreferredSize(
              preferredSize: Size.fromHeight(isPrivate ? kToolbarHeight + 32 : kToolbarHeight),
